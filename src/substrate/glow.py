...
def caption_ink_top(
    ...
    rather than off the block's own drawing origin, and off the caption the
    piece actually ships rather than off the lines being drawn right now, so
    the hook holds still while an opening title card fades.
    """
